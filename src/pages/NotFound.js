...
export default function NotFound() {
    return (
        <div className="flex flex-grow items-center justify-center mx-auto px-4 w-full">
            <section className="py-8 px-4 text-center">
                <div className="max-w-auto mx-auto">
                    <div className="md:max-w-lg mx-auto">
                        <svg className="fill-current text-gray-800" viewBox="0 0 445 202" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h2 className="mt-8 uppercase text-xl lg:text-5xl text-gray-800 font-NovaFlat">That's weird... There's nothing here!</h2>
                    <Link to="/" className="mt-6 bg-green-200 hover:bg-green-300 text-white font-light py-4 px-6 rounded-2xl inline-block uppercase shadow-md">Go To Homepage</Link>
                </div>
            </section>
        </div>
    )
